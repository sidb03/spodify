...
var song1Hash = "QmUFpjArDctm2diYP2zx81ME3pnW6vDhM3YSNB5X6YVG4M";
var vanceArt = "QmfSnz9LKAJhsrdoXhby7YxhCTWFztCCUq1R7YRhw3GMdn";
var bonArt = "QmNgguKVX4KV8saTUTzP4rVKR9zkcGRyeezVTgQc7p9sZ7";
var song2Hash = "QmUGBxmeBXHGJ4L14BB998aBLSdDYBiur1RrLePFBDNXv4";
module.exports = async function (callback) {
    console.log("Registering 1st artist!");
    await registeringSingleArtist("Vance Joy", "My fav artist", vanceArt, web3.eth.accounts[1]);
    console.log("Registering 2nd artist!");
    await registeringSingleArtist("Bon Iver", "My 2nd fav artist", bonArt, web3.eth.accounts[2]);


    console.log("\n Adding songs now!");
    console.log("\nAdding song for vance! Georgia!");
    await addSongs(song1Hash, "Georgia", "2", vanceArt, artist1);
    console.log("\nAdding song for bon! Holocene!");
    await addSongs(song2Hash, "Holocene", "3", bonArt, artist2);
